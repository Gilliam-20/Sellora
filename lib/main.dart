...
Future<void> main() async {
  ...
  // Always initialized: AuthRepository/StoreRepository are wired to their
  // real Supabase implementations unconditionally (see InitialBinding),
  // independent of AppConstants.useMockData, which only decides the rest of
  // the app's repositories. Unlike Firebase, one config serves every
  // platform — see SupabaseConfig.
