        ...
        child: ListView(
          ...
          children: [
            CircleAvatar(
              ...
              child: Text(
                (user?.storeName?.isNotEmpty == true ? user!.storeName![0] : '?').toUpperCase(),
                style: const TextStyle(fontSize: 24, color: AppColors.manifestGoldDeep, fontWeight: FontWeight.w700),
              ),
            ),
            const SizedBox(height: AppSpacing.md),
            Text(user?.storeName ?? '', style: Theme.of(context).textTheme.titleLarge),
            ...
            ListTile(
              ...
              trailing: const Icon(Icons.chevron_right),
              onTap: () => Get.toNamed('/login', arguments: {'intent': 'buyer'}),
            ),
            ListTile(
              contentPadding: EdgeInsets.zero,
