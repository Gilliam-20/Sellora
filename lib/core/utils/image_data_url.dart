...
/// that already hold hosted URLs — no `firebase_storage` upload step exists
...
/// Firestore-backed `StoreRepository`.
///
/// Kept well under Firestore's 1MB document limit, since `updateStore` writes
/// the whole `StoreModel` in one `.update()` call.
