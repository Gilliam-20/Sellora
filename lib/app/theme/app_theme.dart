...
class AppTheme {
  ...
  /// A deliberately paired dark theme for seller work that runs late into
  /// the day. Semantic colors remain consistent with light mode; only the
  /// surfaces and text hierarchy change.
  static ThemeData get dark {
    final base = ThemeData.dark(useMaterial3: true);
    const surface = Color(0xFF171A2E);
    const surfaceVariant = Color(0xFF222744);
    const onSurface = Color(0xFFF5F6FC);
    const muted = Color(0xFFB9BED4);

    return base.copyWith(
      scaffoldBackgroundColor: surface,
      primaryColor: AppColors.manifestGold,
      colorScheme: base.colorScheme.copyWith(
        primary: AppColors.manifestGold,
        secondary: AppColors.cargoNavy,
        tertiary: AppColors.horizonTeal,
        error: AppColors.danger,
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(AppRadii.card),
          side: const BorderSide(color: Color(0xFF363D62)),
        ),
        margin: EdgeInsets.zero,
      ),
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: AppTypography.textTheme.bodyMedium?.copyWith(color: muted),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(AppRadii.stub + 8),
          borderSide: const BorderSide(color: Color(0xFF363D62)),
        ),
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(AppRadii.stub + 8),
          borderSide: const BorderSide(color: Color(0xFF363D62)),
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        backgroundColor: AppColors.cargoNavyDeep,
        selectedItemColor: AppColors.manifestGold,
