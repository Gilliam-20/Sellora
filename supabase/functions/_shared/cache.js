/**
 * Minimal in-memory LRU+TTL cache, scoped to a single warm function isolate.
 * It won't be shared across cold starts or across the other isolates a
 * burst spins up, but it's free (no extra database reads/writes)
