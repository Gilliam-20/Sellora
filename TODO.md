...
## STATUS (as of 2026-09-15 — see WORKLOG.md and SELLORA_IMPLEMENTATION_PLAN.md for detail)
...
| **4 — Catalog + CJ import** | Client plumbing (endpoints, response parsing, admin sync) reconciled with the real CJ backend 2026-09-14; `ProductVariant` now carries CJ's real per-SKU `vid`/`sku`/price 2026-09-15. Still not started: any product search/import screen actually using this (no variant-picker UI), and CJ integration is still unverified against a real account |
